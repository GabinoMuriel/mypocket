                        ...
                        <div className="space-y-4 p-4 border rounded-lg bg-card mt-2">
                            ...
                            <div className="flex flex-wrap items-center gap-4">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-2 px-4 py-2 bg-[var(--premium-background)] text-[var(--premium)] border border-[var(--premium)] rounded-md shadow-sm hover:opacity-90 transition-opacity"
                                >
